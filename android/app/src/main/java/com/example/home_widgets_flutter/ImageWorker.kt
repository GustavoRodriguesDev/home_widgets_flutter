...
import com.example.home_widgets_flutter.ListviewGlanceWidget
...
class ImageWorker(
    ...
    private suspend fun updateImageWidget(width: Float, height: Float, uri: String) {
        ...
        val glanceIds = manager.getGlanceIds(ListviewGlanceWidget::class.java)
        glanceIds.forEach { glanceId ->
            updateAppWidgetState(context, glanceId) { prefs ->
                prefs[ListviewGlanceWidget.getImageKey(width, height)] = uri
                prefs[ListviewGlanceWidget.sourceKey] = "Picsum Photos"
                prefs[ListviewGlanceWidget.sourceUrlKey] = "https://picsum.photos/"
            }
        }
        ListviewGlanceWidget().updateAll(context)
    }
